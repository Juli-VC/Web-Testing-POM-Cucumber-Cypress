...
export class LoginPage extends CommonPage {
  ...
  showsErrorMessagesUsernameRequired() {
    ...
    cy.get('[data-test="error-button"]').should("exist").and("be.visible");
    cy.get(".error-message-container svg").should("exist").and("be.visible");
    // inputs "x" svg error-icons (without specifying)
    cy.get(".form_group svg").should("exist").and("be.visible");
  }
